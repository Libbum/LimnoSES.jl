@testset "Models" begin
    ...
    @testset "Martin" begin
        ...
        @test LimnoSES.preset_conditions(S1, Martin) == (3.0, [20.0, 3.5, 50.0])
        @test LimnoSES.preset_conditions(S2, Martin) == (3.0, [85.436, 0.0373, 6.061])
        @test LimnoSES.preset_conditions(S3, Martin) == (2.0, [79.597, 0.050, 6.928])
